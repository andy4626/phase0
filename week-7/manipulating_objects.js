...
// I had a trouble passing 8, 9, and 10 because I first did not understand what it meant by carson should be
// an object with a property name.  But after following the instruction word by word, literally I was able to
// figure to set it in correct terms to make the tests pass.  It passed because the key and value of name and 
// its name is an Objects of the lowercased names

// // How difficult was it to add and delete properties outside of the object itself?
// It was easy and straighforward.  It was just like Ruby where you just set it outisde the object and it changes

// // What did you learn about manipulating objects in this challenge?
// I have to be careful with the word object, because I thought that it meant a type of data, like strings, 
// numbers, booleans and etc.  But it was straightforward and similar to Hash which was easier to follow.
